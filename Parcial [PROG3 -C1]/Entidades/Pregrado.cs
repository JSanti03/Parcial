namespace Entidades
{
    public class Pregrado: Estudiante
    {
        ...
        public Pregrado(int documento, string nombre, string apellido, string programa, int semestre, double promedioCorte1, double promedioCorte2, double promedioCorte3): base(documento, nombre, apellido, programa, semestre)
        {
        ...
        {
            return $"PRE;{Documento};{Nombre};{Apellido};{Programa};{Semestre};{PromedioCorte1};{PromedioCorte2};{PromedioCorte3};";
        }
